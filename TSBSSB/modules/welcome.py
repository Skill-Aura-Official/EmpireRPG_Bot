...
import TSBSSB
import TSBSSB.modules.sql.welcome_sql as sql
from TSBSSB import (
    DEMONS,
    DEV_USERS,
    DRAGONS,
...
from TSBSSB.modules.helper_funcs.misc import build_keyboard, revert_buttons
from TSBSSB.modules.helper_funcs.msg_types import get_welcome_type
from TSBSSB.modules.helper_funcs.string_handling import (
    escape_invalid_curly_brackets,
    markdown_parser,
)
from TSBSSB.modules.log_channel import loggable
from TSBSSB.modules.sql.global_bans_sql import is_user_gbanned
        ...
        if should_welc:
            ...
            if new_mem.id == OWNER_ID:
                update.effective_message.reply_text(
                    "Greetings, Founder. The Council is now in session.", reply_to_message_id=reply
                )
                welcome_log = (
            ...
            # Welcome Devs
                ...
                update.effective_message.reply_text(
                    "Attention! A TSB Co-Founder has joined the group.",
                    reply_to_message_id=reply,
                )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
            ...
            # Welcome Sudos
                ...
                update.effective_message.reply_text(
                    "A General Secretary of TSB has arrived. Show respect!",
                    reply_to_message_id=reply,
                )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
            ...
            # Welcome Support
                ...
                update.effective_message.reply_text(
                    "A Senior Advisor has joined the chat.",
                    reply_to_message_id=reply,
                )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
            ...
            # Welcome Whitelisted
                ...
                update.effective_message.reply_text(
                    "A Chief Policy Maker has joined.", reply_to_message_id=reply
                )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
                    f"#USER_JOINED\n"
            ...
            # Welcome Tigers
                ...
                update.effective_message.reply_text(
                    "A TSB Manager has joined.", reply_to_message_id=reply
                )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
                    f"#USER_JOINED\n"
