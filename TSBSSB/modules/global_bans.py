...
import TSBSSB.modules.sql.global_bans_sql as sql
from TSBSSB import (
    DEMONS,
    DEV_USERS,
    DRAGONS,
...
from TSBSSB.modules.helper_funcs.misc import send_to_list
from TSBSSB.modules.sql.users_sql import get_user_com_chats
