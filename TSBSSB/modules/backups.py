...
# from TSBSSB.modules.sql import warns_sql as warnssql
import TSBSSB.modules.sql.blacklist_sql as blacklistsql

# from TSBSSB.modules.sql import cust_filters_sql as filtersql
# import TSBSSB.modules.sql.welcome_sql as welcsql
import TSBSSB.modules.sql.locks_sql as locksql
import TSBSSB.modules.sql.notes_sql as sql

# from TSBSSB.modules.rules import get_rules
import TSBSSB.modules.sql.rules_sql as rulessql
from TSBSSB import EVENT_LOGS, LOGGER, OWNER_ID, SUPPORT_CHAT, dispatcher
from TSBSSB.__main__ import DATA_IMPORT
from TSBSSB.modules.connection import connected
from TSBSSB.modules.helper_funcs.alternate import typing_action
from TSBSSB.modules.helper_funcs.chat_status import user_admin
from TSBSSB.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("TSBSSB{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("TSBSSB{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `TSBSSB-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("TSBSSB{}.backup".format(chat_id))  # Cleaning file
