...
if ENV:
    ...
    from TSBSSB.config import Development as Config
...
pbot = Client("TSBSSB", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN, in_memory=True)
...
from TSBSSB.modules.helper_funcs.handlers import (
