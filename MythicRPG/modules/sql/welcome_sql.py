...
from MythicRPG.modules.helper_funcs.msg_types import Types
from MythicRPG.modules.sql import BASE, SESSION

DEFAULT_WELCOME = "Hey {first}, how are you?"
DEFAULT_GOODBYE = "Nice knowing ya!"

DEFAULT_WELCOME_MESSAGES = [
    "{first} has entered the TSB safe zone.",
    "Welcome, {first}. The Council acknowledges your arrival.",
    "A new member, {first}, has joined the brotherhood.",
    "The gate opens for {first}. Welcome.",
    "Greetings, {first}. Your journey with TSB starts here.",
    "Security check cleared for {first}.",
    ...
    "Welcome {first}, the brotherhood grows stronger.",
    "A TSB member has arrived.",
    "Security scan complete. Welcome {first}.",
    ...
    "Welcome to the dark side, {first}.",
    "Hola {first}, the TSB Shield is active here.",
    "Hey {first}, we have the knowledge you are looking for.",
    ...
    "Stay safe {first}, Keep your discussions productive.",
    "Hey {first}, TSB V2 is now protecting you.",
